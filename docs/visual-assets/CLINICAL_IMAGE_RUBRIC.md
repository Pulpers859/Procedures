...
Ground truth: procedural access geometry, not a routine TTE teaching image. Preferred composition is a reference-style procedural plate: anterior torso with semi-transparent ribs/sternum/costal margins, real syringe/needle entering the subxiphoid/substernal region, and a magnified cardiac inset showing the needle tip in the blue pericardial fluid pocket. The view orientation must be explicit in the composition: in an anterior-facing torso view, the patient's right side is image-left and the patient's left shoulder direction is image-right/superior. Show only the subxiphoid/substernal approach for this asset, not parasternal/apical comparison routes. Needle path is the dominant teaching element: shallow, under the costal margin, toward the patient's left shoulder, with the tip visibly terminating inside pericardial fluid rather than on epicardium or myocardium. In screen coordinates, the main needle should read as a forward-slash direction from lower-left/bottom-center toward upper-right; it must not read as lower-right to upper-left. Myocardium and liver are visible as separate unlabeled danger anatomy so a steep/deep path reads as unsafe. Liver danger anatomy must appear on the patient's right upper abdomen / image-left side in that anterior-facing view, not mirrored to the patient's left, and the needle path must remain visibly clear of the liver. This asset should be unlabeled; path and direction should be understood visually.
Auto-fail: image reads primarily as a TTE/subxiphoid probe view rather than the procedure; no anterior torso/procedural instrument context; no useful magnified cardiac inset; multiple approach needles/routes shown in this single-focus asset; needle is visually secondary; main needle points lower-right to upper-left instead of lower-left/bottom-center to upper-right; patient laterality is mirrored; liver is on the wrong anatomical side for the chosen view; no liver danger anatomy; needle path crosses, touches, or appears to enter the liver; no myocardium danger anatomy; steep/deep trajectory appears acceptable; needle starts inside the heart; needle tip reads as touching/entering epicardium or myocardium rather than blue pericardial fluid; any effusion/target mark lands on myocardium or heart wall rather than fluid; needle/tool/catheter/guidewire passes through or in front of the myocardium; a thick tube substitutes for the needle path; liver/myocardium/basic-anatomy labels clutter the procedural geometry view; direction labels such as "Toward left shoulder"; path labels such as "Shallow needle path"; approach letters such as A/B/C; arrow loops/curls/points downward out of the body; title/caption/subtitle text.
