...
class TransvenousPacemakerTests(unittest.TestCase):
    ...
    def test_the_balloon_rules_are_present(self):
        ...
        # "once the tip is past the introducer and never inside it" was cut on
        # 2026-08-05 as foundational knowledge for this app's reader - an EM or
        # critical care resident or attending - not as an oversight. The other
        # two balloon rules still hold.
    ...
    def test_the_threshold_and_safety_margin_are_numeric(self):
        ...
        # positioning problem, not a setting" was cut on 2026-08-05 as
        # foundational for this reader. The safety margin and the insertion
        # depth are still pinned.
